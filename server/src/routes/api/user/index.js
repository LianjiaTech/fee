...
let detail = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/detail',
...
let update = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/update',
...
let deleteRecord = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/delete',
  RouterConfigBuilder.METHOD_TYPE_GET,
  async (req, res) => {
    let request = req.query
...
let search = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/search',
  RouterConfigBuilder.METHOD_TYPE_GET,
  async (req, res) => {
    let request = req.query
...
let searchUC = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/search_uc',
  RouterConfigBuilder.METHOD_TYPE_GET,
  async (req, res) => {
    let request = req.query
...
const register = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/register',
  RouterConfigBuilder.METHOD_TYPE_POST,
  async (req, res) => {
...
const modifyPassword = RouterConfigBuilder.routerConfigBuilder(
  ...
  async (req, res) => {
    ...
    const oldPassword = UCommon.decrypt(_.get(body, ['oldPassword'], ''))
...
const modifyMsg = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/modify/msg',
  RouterConfigBuilder.METHOD_TYPE_POST,
  async (req, res) => {
    const body = _.get(req, ['body'], {})
...
const destroyAccount = RouterConfigBuilder.routerConfigBuilder(
  '/api/user/destroy',
  RouterConfigBuilder.METHOD_TYPE_GET,
  async (req, res) => {
    const ucid = _.get(req, ['fee', 'user', 'ucid'], 0)

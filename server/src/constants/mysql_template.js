export const SINGLE_T_O_USER = 't_o_user' // 用户表
export const SINGLE_T_O_PROJECT = 't_o_project' //  项目表
export const SINGLE_T_O_PROJECT_APPLY = 't_o_project_apply' // 接入项目审核表
export const SINGLE_T_O_PROJECT_MEMBER = 't_o_project_member' // 项目成员表

export const SINGLE_T_O_DIARY = 't_o_count_diary'  // 报错数据日报统计表
export const SINGLE_T_R_ALARM_LOG = 't_r_alarm_log' // 报警记录表
export const SINGLE_T_O_ALARM_CONFIG = 't_o_alarm_config' // 报警配置表

export const SINGLE_T_R_COUNT_DAILY = 't_r_count_daily' //  性能数据日报统计表
export const SINGLE_T_O_ALARM_ES_ID = 't_o_alarm_es_id'  // 错误报警es id记录表
export const SINGLE_T_O_SOURCEMAP = 't_o_sourcemap'  // sourceMap表

export const SINGLE_T_O_DOT_EVENT_INFO = 't_o_dot_event_info'  // 打点事件配置表
export const SINGLE_T_O_DOT_EVENT_PROPS = 't_o_dot_event_props'  // 打点事件属性配置表
export const SINGLE_T_O_DOT_EVENT_TAGS = 't_o_dot_event_tags'  // 打点事件tag配置表
export const SINGLE_T_O_DAILY_SUBSCRIBE = 't_o_daily_subscribe'  // 日报订阅表

...
class DATE_FORMAT {
  ...
  // 数据库GroupBy
  static get SQL_GROUP_BY_YEAR () { return '%Y' }

  static get SQL_GROUP_BY_MONTH () { return '%Y-%m' }

  static get SQL_GROUP_BY_DAY () { return '%Y-%m-%d' }

  static get SQL_GROUP_BY_HOUR () { return '%Y-%m-%d %H' }

  static get SQL_GROUP_BY_MINUTE () { return '%Y-%m-%d %H:%i' }

  static get SQL_GROUP_BY_SECOND () { return '%Y-%m-%d %H:%i:%s' }

  static get SQL_GROUP_BY_MILLSECOND () { return '%Y-%m-%d %H:%i:%s.%f' }
  ...
  // 数据库记录
  static get DATABASE_BY_YEAR () { return 'YYYY' }

  static get DATABASE_BY_MONTH () { return 'YYYY-MM' }

  static get DATABASE_BY_DAY () { return 'YYYY-MM-DD' }

  static get DATABASE_BY_HOUR () { return 'YYYY-MM-DD_HH' }

  static get DATABASE_BY_MINUTE () { return 'YYYY-MM-DD_HH:mm' }

  static get DATABASE_BY_SECOND () { return 'YYYY-MM-DD_HH:mm:ss' }

  static get DATABASE_BY_MILLSECOND () { return 'YYYY-MM-DD_HH:mm:ss.SSS' }
  ...
  // ES记录
  static get ELASTIC_SEARCH_BY_YEAR () { return 'yyyy' }

  static get ELASTIC_SEARCH_BY_MONTH () { return 'yyyy-MM' }

  static get ELASTIC_SEARCH_BY_DAY () { return 'yyyy-MM-dd' }

  static get ELASTIC_SEARCH_BY_HOUR () { return 'yyyy-MM-dd HH:00:00' }

  static get ELASTIC_SEARCH_BY_MINUTE () { return 'yyyy-MM-dd HH:mm:00' }

  static get ELASTIC_SEARCH_BY_SECOND () { return 'yyyy-MM-dd HH:mm:ss' }

  static get ELASTIC_SEARCH_BY_MILLSECOND () { return 'yyyy-MM-dd HH:mm:ss.SSS' }
  ...
  // 命令行参数
  static get COMMAND_ARGUMENT_BY_YEAR () { return 'YYYY' }

  static get COMMAND_ARGUMENT_BY_MONTH () { return 'YYYY-MM' }

  static get COMMAND_ARGUMENT_BY_DAY () { return 'YYYY-MM-DD' }

  static get COMMAND_ARGUMENT_BY_HOUR () { return 'YYYY-MM-DD HH' }

  static get COMMAND_ARGUMENT_BY_MINUTE () { return 'YYYY-MM-DD HH:mm' }

  static get COMMAND_ARGUMENT_BY_SECOND () { return 'YYYY-MM-DD HH:mm:ss' }

  static get COMMAND_ARGUMENT_BY_MILLSECOND () { return 'YYYY-MM-DD HH:mm:ss.SSS' }
  ...
  // 数据展示
  static get DISPLAY_BY_YEAR () { return 'YYYY' }

  static get DISPLAY_BY_MONTH () { return 'YYYY-MM' }

  static get DISPLAY_BY_DAY () { return 'YYYY-MM-DD' }

  static get DISPLAY_BY_HOUR () { return 'YYYY-MM-DD HH' }

  static get DISPLAY_BY_MINUTE () { return 'YYYY-MM-DD HH:mm' }

  static get DISPLAY_BY_SECOND () { return 'YYYY-MM-DD HH:mm:ss' }

  static get DISPLAY_BY_MILLSECOND () { return 'YYYY-MM-DD HH:mm:ss.SSS' }

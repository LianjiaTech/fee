<template>
  <div>
    ...
    <v-chart :forceFit="forceFit" :height="height" :data="dv" :scale="scale" :padding="padding">
      <v-tooltip enterable />
      <v-axis/>
      <v-line position="index*value" :size="2" color="name" adjust="stack" v-if="hasLine"/>
      <v-legend data-key="name" position="bottom"/>
      <v-stack-area position="index*value" color="name"/>
    </v-chart>

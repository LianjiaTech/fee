        ...
        <Input v-model="callbackUrl" style="width: 500px;">
          ...
          <Tooltip transfer max-width="200" slot="append">
            ...
            <div slot="content">
              ...
              <a style="display: inline-block" href="http://weapons.ke.com/project/358/wiki/page/3173">参见文档</a>
            </div>
          </Tooltip>
        </Input>
      </FormItem>
    ...
    methods: {
      async init() {
        ...
        let { 
          ...
          protocol,
          callbackUrl
        } = await this.getSubscribeProject()
      ...
      getParams() {
        let errorMsg = null
        if(this.needCallback && !this.callbackUrl) return {
          errorMsg: '回调接口地址不能为空！'
        }
